...
describe('Utilities', function() {
  ...
  describe('createGames', () => {
    ...
    test('should error if the first argument is not an array', () => {
      expect(_.createGames.bind(this, {invalid: 'invalid'}, 8), 1).to.throw(TypeError, /must be an array/);
    });

    test('should error if the second argument is not a number', () => {
      expect(_.createGames.bind(this, [1, 2, 3], '4', 1)).to.throw(TypeError, /must be a number/);
    });

    test('should return an array of game objects to be inserted into the database', () => {
    ...
    test('should accept a third argument for the rounds to be played', () => {
  ...
  describe('formatName', () => {
    ...
    test('should accept a string, Error on incorrect types', () => {
    ...
    test('should output the correctly formated string', () => {
